...
class ResultsApi:
    ...
    def create_result_v2(
        ...
        _param = self._create_result_v2_serialize(
    ...
    @validate_call
    def create_result_v2_with_http_info(
        self,
        project_code: StrictStr,
        run_id: StrictInt,
        result_create: ResultCreate,
    ...
    @validate_call
    def create_result_v2_without_preload_content(
        self,
        project_code: StrictStr,
        run_id: StrictInt,
        result_create: ResultCreate,
    ...
    def _create_result_v2_serialize(
        self,
        project_code,
        run_id,
        result_create,
        ...
        if project_code is not None:
            _path_params['project_code'] = project_code
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{project_code}/run/{run_id}/result',
    ...
    def create_results_v2(
        ...
        :param run_id: (required)
        :type run_id: int
        :param create_results_request_v2: (required)
        :type create_results_request_v2: CreateResultsRequestV2
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_results_v2_serialize(
            project_code=project_code,
            run_id=run_id,
            create_results_request_v2=create_results_request_v2,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_results_v2_with_http_info(
        self,
        project_code: StrictStr,
        run_id: StrictInt,
        create_results_request_v2: CreateResultsRequestV2,
    ...
    @validate_call
    def create_results_v2_without_preload_content(
        self,
        project_code: StrictStr,
        run_id: StrictInt,
        create_results_request_v2: CreateResultsRequestV2,
    ...
    def _create_results_v2_serialize(
        self,
        project_code,
        run_id,
        ...
        # process the form parameters
        # process the body parameter
        if create_results_request_v2 is not None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{project_code}/run/{run_id}/results',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
