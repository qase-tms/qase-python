...
class ResultStep(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "execution", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResultStepData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "execution": ResultStepExecution.from_dict(obj["execution"]) if obj.get("execution") is not None else None,
            "steps": obj.get("steps")
        })
        return _obj
