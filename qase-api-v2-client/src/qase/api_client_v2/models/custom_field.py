...
class CustomField(BaseModel):
    ...
    value: Optional[List[CustomFieldOption]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "entity", "type", "placeholder", "default_value", "value", "is_required", "is_visible", "is_filterable", "is_enabled_for_all_projects", "created_at", "updated_at", "projects_codes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CustomFieldOption.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
