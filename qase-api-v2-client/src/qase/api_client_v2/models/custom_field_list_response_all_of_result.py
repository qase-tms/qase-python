...
class CustomFieldListResponseAllOfResult(BaseModel):
    """
    ...
    entities: Optional[List[CustomField]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "entities": [CustomField.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None
        })
        return _obj
