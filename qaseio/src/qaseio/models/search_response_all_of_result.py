...
class SearchResponseAllOfResult(BaseModel):
    ...
    total: StrictInt
    __properties: ClassVar[List[str]] = ["entities", "total"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "entities": [SearchResponseAllOfResultEntities.from_dict(_item) for _item in obj.get("entities")] if obj.get("entities") is not None else None,
            "total": obj.get("total")
        })
        return _obj
