...
class TestCase(BaseModel):
    ...
    deleted: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [TestStep.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None,
            "params": TestCaseParams.from_dict(obj.get("params")) if obj.get("params") is not None else None,
            ...
            "external_issues": [ExternalIssue.from_dict(_item) for _item in obj.get("external_issues")] if obj.get("external_issues") is not None else None
        })
        return _obj
