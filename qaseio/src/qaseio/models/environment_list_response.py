...
class EnvironmentListResponse(BaseModel):
    ...
    result: Optional[EnvironmentListResponseAllOfResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "result": EnvironmentListResponseAllOfResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
