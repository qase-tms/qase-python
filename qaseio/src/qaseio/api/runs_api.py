...
class RunsApi:
    ...
    def get_runs(
        ...
        status: Annotated[Optional[StrictStr], Field(description="A list of status values separated by comma. Possible values: active, complete, abort. ")] = None,
        ...
        :param search:
        :type search: str
        :param status: A list of status values separated by comma. Possible values: active, complete, abort. 
        :type status: str
        :param milestone:
        :type milestone: int
        :param environment:
