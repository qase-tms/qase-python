...
class MilestonesApi:
    ...
    def create_milestone(
        ...
        :type code: str
        :param milestone_create: (required)
        :type milestone_create: MilestoneCreate
    ...
    def _create_milestone_serialize(
        ...
        if milestone_create is not None:
            _body_params = milestone_create
    ...
    def _delete_milestone_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/milestone/{code}/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_milestone(
        ...
        :param id: Identifier. (required)
        :type id: int
        :param milestone_update: (required)
        :type milestone_update: MilestoneUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
