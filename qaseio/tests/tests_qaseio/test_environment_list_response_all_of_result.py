...
class TestEnvironmentListResponseAllOfResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnvironmentListResponseAllOfResult:
        """Test EnvironmentListResponseAllOfResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentListResponseAllOfResult`
        """
        ...
        if include_optional:
            return EnvironmentListResponseAllOfResult(
                ...
                count = 56,
                entities = [
                    qaseio.models.environment.Environment(
                        id = 56, 
                        title = '', 
                        description = '', 
                        slug = '', 
