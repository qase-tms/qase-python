...
# body param
SchemaForRequestBodyApplicationJson = ResultCreateBulk


request_body_result_create_bulk = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_result_bulk_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_result_create_bulk.serialize(body, content_type)
...
class CreateResultBulk(BaseApi):
    ...
    def create_result_bulk(
        ...
        return self._create_result_bulk_oapg(
            body=body,
