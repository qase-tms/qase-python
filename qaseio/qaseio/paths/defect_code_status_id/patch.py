...
# body param
SchemaForRequestBodyApplicationJson = DefectStatus


request_body_defect_status = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_defect_status_oapg(
        self,
    ...
    def _update_defect_status_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_defect_status.serialize(body, content_type)
...
class UpdateDefectStatus(BaseApi):
    ...
    def update_defect_status(
        ...
        return self._update_defect_status_oapg(
            body=body,
