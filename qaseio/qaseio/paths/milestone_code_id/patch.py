...
# body param
SchemaForRequestBodyApplicationJson = MilestoneUpdate


request_body_milestone_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_milestone_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_milestone_update.serialize(body, content_type)
...
class UpdateMilestone(BaseApi):
    ...
    def update_milestone(
        ...
        return self._update_milestone_oapg(
            body=body,
