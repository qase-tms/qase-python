...
SchemaFor200ResponseBodyApplicationJson = EnvironmentListResponse
...
class GetEnvironments(BaseApi):
    ...
    def get_environments(
        ...
        return self._get_environments_oapg(
