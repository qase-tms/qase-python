...
# body param
SchemaForRequestBodyApplicationJson = TestCaseUpdate


request_body_test_case_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_case_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_test_case_update.serialize(body, content_type)
