...
# body param
SchemaForRequestBodyApplicationJson = CustomFieldUpdate


request_body_custom_field_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_custom_field_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_custom_field_update.serialize(body, content_type)
