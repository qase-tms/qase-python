...
SchemaFor200ResponseBodyApplicationJson = SharedStepListResponse
...
class GetSharedSteps(BaseApi):
    ...
    def get_shared_steps(
        ...
        return self._get_shared_steps_oapg(
