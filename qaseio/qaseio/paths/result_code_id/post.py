...
# body param
SchemaForRequestBodyApplicationJson = ResultCreate


request_body_result_create = api_client.RequestBody(
    content={
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    class result(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["case_id", "hash", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["case_id", "hash", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _create_result_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_result_create.serialize(body, content_type)
...
class CreateResult(BaseApi):
    ...
    def create_result(
        ...
        return self._create_result_oapg(
            body=body,
