...
# body param
SchemaForRequestBodyApplicationJson = ResultUpdate


request_body_result_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_result_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_result_update.serialize(body, content_type)
...
class UpdateResult(BaseApi):
    ...
    def update_result(
        ...
        return self._update_result_oapg(
            body=body,
