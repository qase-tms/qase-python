...
# body param
SchemaForRequestBodyApplicationJson = PlanUpdate


request_body_plan_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_plan_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_plan_update.serialize(body, content_type)
