...
# body param
SchemaForRequestBodyApplicationJson = SharedStepUpdate


request_body_shared_step_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = HashResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_shared_step_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_shared_step_update.serialize(body, content_type)
...
class UpdateSharedStep(BaseApi):
    ...
    def update_shared_step(
        ...
        return self._update_shared_step_oapg(
            body=body,
