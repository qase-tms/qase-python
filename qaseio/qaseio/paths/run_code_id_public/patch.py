...
# body param
SchemaForRequestBodyApplicationJson = RunPublic


request_body_run_public = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RunPublicResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_run_publicity_oapg(
        self,
    ...
    def _update_run_publicity_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_run_public.serialize(body, content_type)
...
class UpdateRunPublicity(BaseApi):
    ...
    def update_run_publicity(
        ...
        return self._update_run_publicity_oapg(
            body=body,
