...
# body param
SchemaForRequestBodyApplicationJson = EnvironmentUpdate


request_body_environment_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_environment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_environment_update.serialize(body, content_type)
...
class UpdateEnvironment(BaseApi):
    ...
    def update_environment(
        ...
        return self._update_environment_oapg(
            body=body,
