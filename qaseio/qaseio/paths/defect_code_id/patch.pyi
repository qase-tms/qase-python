...
# body param
SchemaForRequestBodyApplicationJson = DefectUpdate


request_body_defect_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_defect_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_defect_update.serialize(body, content_type)
...
class UpdateDefect(BaseApi):
    ...
    def update_defect(
        ...
        return self._update_defect_oapg(
            body=body,
