...
# body param
SchemaForRequestBodyApplicationJson = SuiteUpdate


request_body_suite_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_suite_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_suite_update.serialize(body, content_type)
...
class UpdateSuite(BaseApi):
    ...
    def update_suite(
        ...
        return self._update_suite_oapg(
            body=body,
