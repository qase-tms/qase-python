...
# body param
SchemaForRequestBodyApplicationJson = SuiteDelete


request_body_suite_delete = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _delete_suite_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_suite_delete.serialize(body, content_type)
...
class DeleteSuite(BaseApi):
    ...
    def delete_suite(
        ...
        return self._delete_suite_oapg(
            body=body,
