...
class ProjectListResponse(BaseModel):
    ...
    result: Optional[ProjectListResponseAllOfResult] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "result": ProjectListResponseAllOfResult.from_dict(obj.get("result")) if obj.get("result") is not None else None
        })
        return _obj
