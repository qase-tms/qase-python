...
class ProjectCounts(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "runs": ProjectCountsRuns.from_dict(obj.get("runs")) if obj.get("runs") is not None else None,
            "defects": ProjectCountsDefects.from_dict(obj.get("defects")) if obj.get("defects") is not None else None
        })
        return _obj
