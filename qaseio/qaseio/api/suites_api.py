...
class SuitesApi:
    ...
    def create_suite(
        ...
        :type code: str
        :param suite_create: (required)
        :type suite_create: SuiteCreate
        ...
        _param = self._create_suite_serialize(
            code=code,
    ...
    @validate_call
    def create_suite_with_http_info(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        suite_create: SuiteCreate,
        _request_timeout: Union[
    ...
    @validate_call
    def create_suite_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        suite_create: SuiteCreate,
        _request_timeout: Union[
    ...
    def _create_suite_serialize(
        ...
        if suite_create is not None:
            _body_params = suite_create
    ...
    def delete_suite(
        ...
        suite_delete: Optional[SuiteDelete] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_suite_serialize(
            code=code,
            id=id,
    ...
    @validate_call
    def delete_suite_with_http_info(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        id: Annotated[StrictInt, Field(description="Identifier.")],
        suite_delete: Optional[SuiteDelete] = None,
    ...
    @validate_call
    def delete_suite_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        id: Annotated[StrictInt, Field(description="Identifier.")],
        suite_delete: Optional[SuiteDelete] = None,
    ...
    def _delete_suite_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if suite_delete is not None:
            _body_params = suite_delete
    ...
    def get_suite(
        ...
        _param = self._get_suite_serialize(
            code=code,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_suite_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        id: Annotated[StrictInt, Field(description="Identifier.")],
        _request_timeout: Union[
    ...
    def get_suites(
        ...
        _param = self._get_suites_serialize(
            code=code,
            search=search,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_suites_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        search: Annotated[Optional[StrictStr], Field(description="Provide a string that will be used to search by name.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A number of entities in result set.")] = None,
    ...
    def update_suite(
        ...
        :param id: Identifier. (required)
        :type id: int
        :param suite_update: (required)
        :type suite_update: SuiteUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_suite_serialize(
            code=code,
            id=id,
    ...
    @validate_call
    def update_suite_with_http_info(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        id: Annotated[StrictInt, Field(description="Identifier.")],
        suite_update: SuiteUpdate,
    ...
    @validate_call
    def update_suite_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        id: Annotated[StrictInt, Field(description="Identifier.")],
        suite_update: SuiteUpdate,
    ...
    def _update_suite_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if suite_update is not None:
            _body_params = suite_update
