...
class EnvironmentCreate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "slug", "description", "host", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "slug", "description", "host", ], str]):
