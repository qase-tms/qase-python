...
class CustomFieldUpdate(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["replace_values"]) -> MetaOapg.properties.replace_values: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "value", "replace_values", "placeholder", "default_value", "is_filterable", "is_visible", "is_required", "is_enabled_for_all_projects", "projects_codes", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["replace_values"]) -> typing.Union[MetaOapg.properties.replace_values, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "value", "replace_values", "placeholder", "default_value", "is_filterable", "is_visible", "is_required", "is_enabled_for_all_projects", "projects_codes", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        replace_values: typing.Union[MetaOapg.properties.replace_values, dict, frozendict.frozendict, None, schemas.Unset] = schemas.unset,
