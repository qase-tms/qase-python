...
class TestStepCreate(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TestStepCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            steps ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Nested steps may be passed here. Use same structure for them.. [optional]  # noqa: E501
        """
