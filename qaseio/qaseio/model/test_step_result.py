...
class TestStepResult(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            steps ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Nested steps results will be here. The same structure is used for them for them.. [optional]  # noqa: E501
        """
