...
class TestStepResultCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, position, status, *args, **kwargs):  # noqa: E501
        """TestStepResultCreate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            steps ([{str: (bool, date, datetime, dict, float, int, list, str, none_type)}]): Nested steps results may be passed here. Use same structure for them.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, position, status, *args, **kwargs):  # noqa: E501
        """TestStepResultCreate - a model defined in OpenAPI
