...
class Attachment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["size", "mime", "filename", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["size", "mime", "filename", "url", ], str]):
