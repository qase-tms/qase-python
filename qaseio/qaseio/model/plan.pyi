...
class Plan(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "title", "description", "cases_count", "created_at", "updated_at", "created", "updated", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "title", "description", "cases_count", "created_at", "updated_at", "created", "updated", ], str]):
