...
class DefectCreate(
    ...
    actual_result: MetaOapg.properties.actual_result
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["actual_result"]) -> MetaOapg.properties.actual_result: ...
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        severity: typing.Union[MetaOapg.properties.severity, decimal.Decimal, int, ],
        actual_result: typing.Union[MetaOapg.properties.actual_result, str, ],
