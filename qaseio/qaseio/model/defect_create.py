...
class DefectCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, actual_result, severity, *args, **kwargs):  # noqa: E501
        """DefectCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, actual_result, severity, *args, **kwargs):  # noqa: E501
        """DefectCreate - a model defined in OpenAPI
