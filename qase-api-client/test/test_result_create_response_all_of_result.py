...
class TestResultCreateResponseAllOfResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResultCreateResponseAllOfResult:
        ...
        # uncomment below to create an instance of `ResultCreateResponseAllOfResult`
        """
        model = ResultCreateResponseAllOfResult()
        if include_optional:
            return ResultCreateResponseAllOfResult(
                case_id = 56,
                hash = ''
            )
        else:
    ...
    def testResultCreateResponseAllOfResult(self):
        """Test ResultCreateResponseAllOfResult"""
