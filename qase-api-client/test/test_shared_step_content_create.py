...
class TestSharedStepContentCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SharedStepContentCreate:
        """Test SharedStepContentCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SharedStepContentCreate`
        """
        model = SharedStepContentCreate()
        if include_optional:
