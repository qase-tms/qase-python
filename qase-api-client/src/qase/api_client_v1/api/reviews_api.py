...
class ReviewsApi:
    ...
    def bulk_create_reviews(
        ...
        :type code: str
        :param review_bulk: (required)
        :type review_bulk: ReviewBulk
        ...
        _param = self._bulk_create_reviews_serialize(
            code=code,
            review_bulk=review_bulk,
    ...
    @validate_call
    def bulk_create_reviews_with_http_info(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        review_bulk: ReviewBulk,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ReviewBulkResponse]:
        """Create reviews in bulk
    ...
    @validate_call
    def bulk_create_reviews_without_preload_content(
        self,
        code: Annotated[str, Field(min_length=2, strict=True, max_length=10, description="Code of project, where to search entities.")],
        review_bulk: ReviewBulk,
        _request_timeout: Union[
    ...
    def _bulk_create_reviews_serialize(
        self,
        code,
        review_bulk,
        _request_auth,
        ...
        if review_bulk is not None:
            _body_params = review_bulk
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/review/{code}/bulk',
    ...
    def get_reviews(
        ...
        case_id: Annotated[Optional[StrictInt], Field(description="Filter reviews by the reviewed test case ID.")] = None,
        author_uuid: Annotated[Optional[UUID], Field(description="Filter reviews by the author who created them (author UUID).")] = None,
        reviewer_uuid: Annotated[Optional[UUID], Field(description="Filter reviews by an assigned reviewer (author UUID).")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Provide a string that will be used to search by review title.")] = None,
        ...
        :param type:
        :type type: str
        :param case_id: Filter reviews by the reviewed test case ID.
        :type case_id: int
        :param author_uuid: Filter reviews by the author who created them (author UUID).
        :type author_uuid: UUID
        :param reviewer_uuid: Filter reviews by an assigned reviewer (author UUID).
        :type reviewer_uuid: UUID
        :param search: Provide a string that will be used to search by review title.
        :type search: str
    ...
    def _get_reviews_serialize(
        ...
        if author_uuid is not None:
            ...
            _query_params.append(('author_uuid', author_uuid))
            
        if reviewer_uuid is not None:
            
            _query_params.append(('reviewer_uuid', reviewer_uuid))
    ...
    def update_review(
        ...
        :param id: Identifier. (required)
        :type id: int
        :param review_update: (required)
        :type review_update: ReviewUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
