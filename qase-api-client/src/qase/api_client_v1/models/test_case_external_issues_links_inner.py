...
class TestCaseExternalIssuesLinksInner(BaseModel):
    """
    TestCaseExternalIssuesLinksInner
    """ # noqa: E501
    case_id: StrictInt
    external_issues: List[StrictStr]
    __properties: ClassVar[List[str]] = ["case_id", "external_issues"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "external_issues": obj.get("external_issues")
        })
        return _obj
