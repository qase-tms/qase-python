...
class SharedParameterResponse(BaseModel):
    """
    SharedParameterResponse
    """ # noqa: E501
    status: Optional[StrictBool] = None
    result: Optional[SharedParameter] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": SharedParameter.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
